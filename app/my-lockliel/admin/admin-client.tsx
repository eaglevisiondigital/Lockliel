...
import { BookOpen, ClipboardCheck, HeartHandshake, ShieldCheck, UserPlus, Users } from "lucide-react";
import { useEffect,useState } from "react";

type AdminData={roles:string[];counts:{people:number;founders:number;activeCourses:number;gifts:number;leads:number;followups:number};applications:any[]};
