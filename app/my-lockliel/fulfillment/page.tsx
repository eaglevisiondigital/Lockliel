...
const FULFILLMENT_ROLES=["super_admin","admin","fulfillment_admin"];

export const metadata={title:"Fulfillment Tools | My Lockliel"};

export default function FulfillmentPage(){
  return <main className="my-lockliel">
    <StaffSecurityGate allowedRoles={FULFILLMENT_ROLES} returnTo="/my-lockliel/fulfillment">
