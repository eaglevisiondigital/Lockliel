...
export default async(request)=>{
 ...
 if(linkId)await fetch(SUPABASE_URL+"/rest/v1/referral_events",{method:"POST",headers:{...h,Prefer:"return=minimal"},body:JSON.stringify({referral_link_id:linkId,event_type:"share_initiated",member_id:s.user.id,metadata:{source:"share-center",asset:slug}})});
